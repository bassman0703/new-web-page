...
/*  Wizard */
jQuery(function ($) {
  "use strict"; // Chose below which method to send the email, available:
  ...
  $("#wizard_container").wizard({
    ...
    beforeSelectz: function beforeSelectz(event, state) {
...
$("#wizard_container").wizard({
  transitions: {
    branchtype: function branchtype($step, action) {
