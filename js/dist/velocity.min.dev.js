...
!function (e) {
  ...
  if (!e.jQuery) {
    ...
    $.isWindow = function (e) {
      ...
      return null == e ? e + "" : "object" == _typeof(e) || "function" == typeof e ? a[o.call(e)] || "object" : _typeof(e);
      ...
      for ("boolean" == typeof i && (u = i, i = arguments[s] || {}, s++), "object" != _typeof(i) && "function" !== $.type(i) && (i = {}), s === l && (i = this, s--); l > s; s++) {
  ...
  return function (e, t, r, a) {
    ...
    function c(e) {
      if (e) for (var t = new Date().getTime(), r = 0, n = v.State.calls.length; n > r; r++) {
        if (v.State.calls[r]) {
