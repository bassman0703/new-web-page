...
!function (t, e) {
  ...
  var g = {
    zTRANSITION_END: "bsTransitionEnd",
  ...
  var y = "carousel",
    ...
    return t.next = function () {
      ...
      var t,
          e,
          i = this;
      this._touchSupported && (t = function t(_t2) {
        i._pointerEvent && A[_t2.originalEvent.pointerType.toUpperCase()] ? i.touchStartX = _t2.originalEvent.clientX : i._pointerEvent || (i.touchStartX = _t2.originalEvent.touches[0].clientX);
      }, e = function e(t) {
  ...
  var M = "collapse",
    ...
    return t.toggle = function () {
      ...
      return this.each(function () {
        var t = f(this),
            e = t.data(N),
            i = l({}, z, t.data(), "object" == _typeof(s) && s ? s : {});
  ...
  function et(t) {
    ...
    for (var e = tt(10) ? document.body : null, i = t.offsetParent || null; i === e && t.nextElementSibling;) {
  ...
  function It(t, e, i, s) {
    i.updateBound = s, St(t).addEventListener("resize", i.updateBound, {
      passive: !0
    });
    var n = X(t);
    return function t(e, i, s, n) {
      ...
      r.addEventListener(i, s, {
        passive: !0
      }), o || t(X(r.parentNode), i, s, n), n.push(r);
  ...
  var Yt = "dropdown",
    ...
    return t.toggle = function () {
      ...
      var t, e, i;
      this._element.disabled || f(this._element).hasClass(ee) || !f(this._menu).hasClass(ie) || (t = {
        relatedTarget: this._element
      }, e = f.Event(Gt, t), i = h._getParentFromElement(this._element), f(i).trigger(e), e.isDefaultPrevented() || (this._popper && this._popper.destroy(), f(this._menu).toggleClass(ie), f(i).toggleClass(ie).trigger(f.Event(Zt, t))));
    }, t.dispose = function () {
      ...
      return this.each(function () {
        ...
        if (t || (t = new h(this, "object" == _typeof(e) ? e : null), f(this).data(Qt, t)), "string" == typeof e) {
  ...
  var he = "modal",
    ...
    return t.toggle = function (t) {
      ...
      var e,
          i = this;
      this._isShown || this._isTransitioning || (f(this._element).hasClass(xe) && (this._isTransitioning = !0), e = f.Event(me, {
        relatedTarget: t
      }), f(this._element).trigger(e), this._isShown || e.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), f(this._element).on(be, '[data-dismiss="modal"]', function (t) {
        return i.hide(t);
      ...
      if (this._isShown && this._config.backdrop) {
        ...
        !this._isShown && this._backdrop ? (f(this._backdrop).removeClass(ke), e = function e() {
      ...
      return this.each(function () {
        var t = f(this).data(ce),
            e = l({}, pe, f(this).data(), "object" == _typeof(i) && i ? i : {});
  ...
  function Me(t, o, e) {
    ...
    for (var i = new window.DOMParser().parseFromString(t, "text/html"), r = Object.keys(o), a = [].slice.call(i.body.querySelectorAll("*")), s = function s(t) {
      var e = a[t],
  ...
  var Ne = "tooltip",
    ...
    return t.enable = function () {
      ...
      "object" != _typeof(e) || !e.nodeType && !e.jquery ? this.config.html ? (this.config.sanitize && (e = Me(e, this.config.whiteList, this.config.sanitizeFn)), t.html(e)) : t.text(e) : this.config.html ? f(e).parent().is(t) || t.empty().append(e) : t.text(f(e).text());
    }, t.getTitle = function () {
  ...
  var ai = "scrollspy",
    ...
    return t.refresh = function () {
      ...
      var e;
      return "string" != typeof (t = l({}, ui, "object" == _typeof(t) && t ? t : {})).target && g.isElement(t.target) && ((e = f(t.target).attr("id")) || (e = g.getUID(ai), f(t.target).attr("id", e)), t.target = "#" + e), g.typeCheckConfig(ai, t, di), t;
      ...
      i.hasClass("dropdown-item") ? (i.closest(".dropdown").find(".dropdown-toggle").addClass(pi), i.addClass(pi)) : (i.addClass(pi), i.parents(fi).prev(gi + ", " + mi).addClass(pi), i.parents(fi).prev(".nav-item").children(gi).addClass(pi)), f(this._scrollElement).trigger("activate.bs.scrollspy", {
        relatedTarget: e
      });
    }, t._clear = function () {
      ...
      return this.each(function () {
        ...
        if (t || (t = new i(this, "object" == _typeof(e) && e), f(this).data(li, t)), "string" == typeof e) {
          if (void 0 === t[e]) throw new TypeError('No method named "' + e + '"');
          t[e]();
        }
      });
  ...
  var bi = "bs.tab",
    ...
    return t.show = function () {
      ...
      this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && f(this._element).hasClass(wi) || f(this._element).hasClass("disabled") || (e = f(this._element).closest(".nav, .list-group")[0], i = g.getSelectorFromElement(this._element), e && (s = "UL" === e.nodeName || "OL" === e.nodeName ? xi : Ci, n = (n = f.makeArray(f(e).find(s)))[n.length - 1]), o = f.Event("hide.bs.tab", {
        relatedTarget: this._element
      }), r = f.Event("show.bs.tab", {
        relatedTarget: n
      }), n && f(n).trigger(o), f(this._element).trigger(r), r.isDefaultPrevented() || o.isDefaultPrevented() || (i && (t = document.querySelector(i)), this._activate(this._element, e), a = function a() {
  ...
  var Di = "toast",
    ...
    return t.show = function () {
      ...
      f(this._element).trigger(s), s.isDefaultPrevented() || (this._clearTimeout(), this._config.animation && this._element.classList.add("fade"), t = function t() {
      ...
      return t = l({}, Mi, f(this._element).data(), "object" == _typeof(t) && t ? t : {}), g.typeCheckConfig(Di, t, this.constructor.DefaultType), t;
    }, t._setListeners = function () {
      var t = this;
      ...
      return this.each(function () {
        ...
        if (e || (e = new s(this, "object" == _typeof(i) && i), t.data(Ei, e)), "string" == typeof i) {
          if (void 0 === e[i]) throw new TypeError('No method named "' + i + '"');
          e[i](this);
        }
      });
  ...
  }, t.Alert = h, t.Button = b, t.Carousel = P, t.Collapse = q, t.Dropdown = le, t.Modal = Ie, t.Popover = ri, t.Scrollspy = _i, t.Tab = ki, t.Toast = Ni, t.Tooltip = Xe, t.Util = g, Object.defineProperty(t, "__esModule", {
    value: !0
  });
}), function (a) {
  function s(t, e) {
  ...
  a.ui = a.ui || {}, a.ui.version || (a.extend(a.ui, {
    ...
    plugin: {
      ...
      call: function call(t, e, i) {
        var s = t.plugins[e];
        if (s && t.element[0].parentNode) for (var n = 0; n < s.length; n++) {
    ...
    isOver: function isOver(t, e, i, s, n, o) {
  ...
  r.cleanData ? (s = r.cleanData, r.cleanData = function (t) {
    ...
    _trigger: function _trigger(t, e, i) {
      var s,
          n,
          o = this.options[t];
      if (i = i || {}, (e = r.Event(e)).type = (t === this.widgetEventPrefix ? t : this.widgetEventPrefix + t).toLowerCase(), e.target = this.element[0], n = e.originalEvent) for (s in n) {
        s in e || (e[s] = n[s]);
      }
  ...
  b.widget("ui.draggable", b.ui.mouse, {
    ...
    _mouseStop: function _mouseStop(t) {
      ...
      for (var i, s = this.element[0], n = !1; s = s && s.parentNode;) {
        s == document && (n = !0);
      }
  ...
  f.widget("ui.resizable", f.ui.mouse, {
    ...
    _updateRatio: function _updateRatio(t, e) {
      this.options;
      var i = this.position,
          s = this.size,
          n = this.axis;
    ...
    _respectSize: function _respectSize(t, e) {
      this.helper;
    ...
    start: function start(t, e) {
      ...
      "object" != _typeof(s.alsoResize) || s.alsoResize.parentNode ? i(s.alsoResize) : s.alsoResize.length ? (s.alsoResize = s.alsoResize[0], i(s.alsoResize)) : f.each(s.alsoResize, function (t) {
        i(t);
      });
    },
    resize: function resize(t, o) {
      ...
      "object" != _typeof(s.alsoResize) || s.alsoResize.nodeType ? i(s.alsoResize) : f.each(s.alsoResize, function (t, e) {
        i(t, e);
      });
    },
    stop: function stop(t, e) {
  ...
  d.widget("ui.sortable", d.ui.mouse, {
    ...
    _getItemsAsjQuery: function _getItemsAsjQuery(t) {
      ...
      if (s && t) for (var n = s.length - 1; 0 <= n; n--) {
    ...
    _refreshItems: function _refreshItems(t) {
      ...
      if (s && this.ready) for (var n = s.length - 1; 0 <= n; n--) {
        for (var o = d(s[n]), r = o.length - 1; 0 <= r; r--) {
          var a = d.data(o[r], this.widgetName);
    ...
    _contactContainers: function _contactContainers(t) {
      for (var e = null, i = null, s = this.containers.length - 1; 0 <= s; s--) {
        if (!d.ui.contains(this.currentItem[0], this.containers[s].element[0])) if (this._intersectsWith(this.containers[s].containerCache)) {
    ...
    _clear: function _clear(t, e) {
      ...
      if (this.fromOutside && !e && i.push(function (t) {
        ...
        for (s = this.containers.length - 1; 0 <= s; s--) {
          d.ui.contains(this.containers[s].element[0], this.currentItem[0]) && !e && (i.push(function (e) {
            return function (t) {
  ...
  function c() {
    var t,
        ...
        i = {};
    if (e && e.length && e[0] && e[e[0]]) for (var s = e.length; s--;) {
  ...
  function u(t) {
    ...
    for (e in t) {
      (null == (i = t[e]) || h.isFunction(i) || e in o || /scrollbar/.test(e) || !/color/i.test(e) && isNaN(parseFloat(i))) && delete t[e];
    }
  ...
  function l(t, e, i, s) {
    return "object" == _typeof(t) && (s = e, i = null, t = (e = t).effect), h.isFunction(e) && (s = e, i = null, e = {}), "number" != typeof e && !h.fx.speeds[e] || (s = i, i = e, e = {}), h.isFunction(i) && (s = i, i = null), e = e || {}, i = i || e.duration, [t, e, i = h.fx.off ? 0 : "number" == typeof i ? i : i in h.fx.speeds ? h.fx.speeds[i] : h.fx.speeds._default, s = s || e.complete];
  }
  ...
  h.effects.animateClass = function (o, r, a, l) {
    return h.isFunction(a) && (l = a, a = null), this.queue(function () {
      ...
      h.each(d, function (t, e) {
        ...
        complete: function complete() {
          h.each(d, function (t, e) {
            o[e] && i[e + "Class"](o[e]);
          }), "object" == _typeof(i.attr("style")) ? (i.attr("style").cssText = "", i.attr("style").cssText = e) : i.attr("style", e), l && l.apply(this, arguments), h.dequeue(this);
        }
      });
    });
  }, h.fn.extend({
    _addClass: h.fn.addClass,
    addClass: function addClass(t, e, i, s) {
      return e ? h.effects.animateClass.apply(this, [{
        add: t
      }, e, i, s]) : this._addClass(t);
    },
    _removeClass: h.fn.removeClass,
    removeClass: function removeClass(t, e, i, s) {
      return e ? h.effects.animateClass.apply(this, [{
        remove: t
      }, e, i, s]) : this._removeClass(t);
    },
    _toggleClass: h.fn.toggleClass,
    toggleClass: function toggleClass(t, e, i, s, n) {
    ...
    effect: function effect(t, e, i, s) {
    ...
    def: "easeOutQuad",
    swing: function swing(t, e, i, s, n) {
      return h.easing[h.easing.def](t, e, i, s, n);
    },
    easeInQuad: function easeInQuad(t, e, i, s, n) {
      return s * (e /= n) * e + i;
    },
    easeOutQuad: function easeOutQuad(t, e, i, s, n) {
      return -s * (e /= n) * (e - 2) + i;
    },
    easeInOutQuad: function easeInOutQuad(t, e, i, s, n) {
      return (e /= n / 2) < 1 ? s / 2 * e * e + i : -s / 2 * (--e * (e - 2) - 1) + i;
    },
    easeInCubic: function easeInCubic(t, e, i, s, n) {
      return s * (e /= n) * e * e + i;
    },
    easeOutCubic: function easeOutCubic(t, e, i, s, n) {
      return s * ((e = e / n - 1) * e * e + 1) + i;
    },
    easeInOutCubic: function easeInOutCubic(t, e, i, s, n) {
      return (e /= n / 2) < 1 ? s / 2 * e * e * e + i : s / 2 * ((e -= 2) * e * e + 2) + i;
    },
    easeInQuart: function easeInQuart(t, e, i, s, n) {
      return s * (e /= n) * e * e * e + i;
    },
    easeOutQuart: function easeOutQuart(t, e, i, s, n) {
      return -s * ((e = e / n - 1) * e * e * e - 1) + i;
    },
    easeInOutQuart: function easeInOutQuart(t, e, i, s, n) {
      return (e /= n / 2) < 1 ? s / 2 * e * e * e * e + i : -s / 2 * ((e -= 2) * e * e * e - 2) + i;
    },
    easeInQuint: function easeInQuint(t, e, i, s, n) {
      return s * (e /= n) * e * e * e * e + i;
    },
    easeOutQuint: function easeOutQuint(t, e, i, s, n) {
      return s * ((e = e / n - 1) * e * e * e * e + 1) + i;
    },
    easeInOutQuint: function easeInOutQuint(t, e, i, s, n) {
      return (e /= n / 2) < 1 ? s / 2 * e * e * e * e * e + i : s / 2 * ((e -= 2) * e * e * e * e + 2) + i;
    },
    easeInSine: function easeInSine(t, e, i, s, n) {
      return -s * Math.cos(e / n * (Math.PI / 2)) + s + i;
    },
    easeOutSine: function easeOutSine(t, e, i, s, n) {
      return s * Math.sin(e / n * (Math.PI / 2)) + i;
    },
    easeInOutSine: function easeInOutSine(t, e, i, s, n) {
      return -s / 2 * (Math.cos(Math.PI * e / n) - 1) + i;
    },
    easeInExpo: function easeInExpo(t, e, i, s, n) {
      return 0 == e ? i : s * Math.pow(2, 10 * (e / n - 1)) + i;
    },
    easeOutExpo: function easeOutExpo(t, e, i, s, n) {
      return e == n ? i + s : s * (1 - Math.pow(2, -10 * e / n)) + i;
    },
    easeInOutExpo: function easeInOutExpo(t, e, i, s, n) {
      return 0 == e ? i : e == n ? i + s : (e /= n / 2) < 1 ? s / 2 * Math.pow(2, 10 * (e - 1)) + i : s / 2 * (2 - Math.pow(2, -10 * --e)) + i;
    },
    easeInCirc: function easeInCirc(t, e, i, s, n) {
      return -s * (Math.sqrt(1 - (e /= n) * e) - 1) + i;
    },
    easeOutCirc: function easeOutCirc(t, e, i, s, n) {
      return s * Math.sqrt(1 - (e = e / n - 1) * e) + i;
    },
    easeInOutCirc: function easeInOutCirc(t, e, i, s, n) {
      return (e /= n / 2) < 1 ? -s / 2 * (Math.sqrt(1 - e * e) - 1) + i : s / 2 * (Math.sqrt(1 - (e -= 2) * e) + 1) + i;
    },
    easeInElastic: function easeInElastic(t, e, i, s, n) {
      var o = 1.70158,
          r = 0,
          a = s;
    ...
    easeOutElastic: function easeOutElastic(t, e, i, s, n) {
      var o = 1.70158,
          r = 0,
          a = s;
    ...
    easeInOutElastic: function easeInOutElastic(t, e, i, s, n) {
      var o = 1.70158,
          r = 0,
          a = s;
    ...
    easeInBack: function easeInBack(t, e, i, s, n, o) {
      return o == r && (o = 1.70158), s * (e /= n) * e * ((o + 1) * e - o) + i;
    },
    easeOutBack: function easeOutBack(t, e, i, s, n, o) {
      return o == r && (o = 1.70158), s * ((e = e / n - 1) * e * ((o + 1) * e + o) + 1) + i;
    },
    easeInOutBack: function easeInOutBack(t, e, i, s, n, o) {
      return o == r && (o = 1.70158), (e /= n / 2) < 1 ? s / 2 * e * e * ((1 + (o *= 1.525)) * e - o) + i : s / 2 * ((e -= 2) * e * ((1 + (o *= 1.525)) * e + o) + 2) + i;
    },
    easeInBounce: function easeInBounce(t, e, i, s, n) {
      return s - h.easing.easeOutBounce(t, n - e, 0, s, n) + i;
    },
    easeOutBounce: function easeOutBounce(t, e, i, s, n) {
    ...
    easeInOutBounce: function easeInOutBounce(t, e, i, s, n) {
  ...
  f.effects.bounce = function (p) {
    return this.queue(function () {
      ...
      "show" == i && t.css("opacity", 0).css(a, "pos" == l ? -n : n), "hide" == i && (n /= 2 * o), "hide" != i && o--, "show" == i && ((h = {
        opacity: 1
      })[a] = ("pos" == l ? "+=" : "-=") + n, t.animate(h, r / 2, p.options.easing), n /= 2, o--);
      ...
      "hide" == i ? ((h = {
        opacity: 0
      })[a] = ("pos" == l ? "-=" : "+=") + n, t.animate(h, r / 2, p.options.easing, function () {
  ...
  d.widget("ui.accordion", {
    ...
    _clickHandler: function _clickHandler(t, e) {
      var i = this.options;
    ...
    _toggle: function _toggle(t, e, i, s, n) {
      var o = this,
          r = o.options;
    ...
    _completed: function _completed(t) {
    ...
    animations: {
      ...
      bounceslide: function bounceslide(t) {
        this.slide(t, {
  ...
  n.widget("ui.menu", {
    ...
    activate: function activate(t, e) {
      var i, s, n;
  ...
  function isArray(t) {
    return t && ($.browser.safari && "object" == _typeof(t) && t.length || t.constructor && t.constructor.toString().match(/\Array\(\)/));
  }
  ...
  $.extend(Datepicker.prototype, {
    ...
    _connectDatepicker: function _connectDatepicker(t, s) {
      var e = $(t);
    ...
    _autoSize: function _autoSize(t) {
      var e, i, s;
      this._get(t, "autoSize") && !t.inline && (e = new Date(2009, 11, 20), (i = this._get(t, "dateFormat")).match(/[DM]/) && (s = function s(t) {
    ...
    _inlineDatepicker: function _inlineDatepicker(t, s) {
      var e = $(t);
    ...
    _showDatepicker: function _showDatepicker(t) {
      ...
      "input" != (t = t.target || t).nodeName.toLowerCase() && (t = $("input", t.parentNode)[0]), $.datepicker._isDisabledDatepicker(t) || $.datepicker._lastInput == t || (i = $.datepicker._getInst(t), $.datepicker._curInst && $.datepicker._curInst != i && ($.datepicker._curInst.dpDiv.stop(!0, !0), i && $.datepicker._datepickerShowing && $.datepicker._hideDatepicker($.datepicker._curInst.input[0])), !1 !== (s = (e = $.datepicker._get(i, "beforeShow")) ? e.apply(t, [t, i]) : {}) && (extendRemove(i.settings, s), i.lastVal = null, $.datepicker._lastInput = t, $.datepicker._setDateFromField(i), $.datepicker._inDialog && (t.value = ""), $.datepicker._pos || ($.datepicker._pos = $.datepicker._findPos(t), $.datepicker._pos[1] += t.offsetHeight), n = !1, $(t).parents().each(function () {
        ...
        left: o.left + "px",
        top: o.top + "px"
      }), i.inline || (r = $.datepicker._get(i, "showAnim"), a = $.datepicker._get(i, "duration"), l = function l() {
        var t,
    ...
    _hideDatepicker: function _hideDatepicker(t) {
      var e,
          ...
          n,
          o = this._curInst;
      !o || t && o != $.data(t, PROP_NAME) || this._datepickerShowing && (e = this._get(o, "showAnim"), i = this._get(o, "duration"), s = function s() {
    ...
    _selectDate: function _selectDate(t, e) {
      ...
      n ? n.apply(s.input ? s.input[0] : null, [e, s]) : s.input && s.input.trigger("change"), s.inline ? this._updateDatepicker(s) : (this._hideDatepicker(), this._lastInput = s.input[0], "object" != _typeof(s.input[0]) && s.input.focus(), this._lastInput = null);
    },
    ...
    parseDate: function parseDate(i, o, t) {
      if (null == i || null == o) throw "Invalid arguments";
      if ("" == (o = "object" == _typeof(o) ? o.toString() : o + "")) return null;
      ...
      for (var a = "string" != typeof (a = (t ? t.shortYearCutoff : null) || this._defaults.shortYearCutoff) ? a : new Date().getFullYear() % 100 + parseInt(a, 10), l = (t ? t.dayNamesShort : null) || this._defaults.dayNamesShort, h = (t ? t.dayNames : null) || this._defaults.dayNames, c = (t ? t.monthNamesShort : null) || this._defaults.monthNamesShort, u = (t ? t.monthNames : null) || this._defaults.monthNames, d = -1, p = -1, f = -1, g = -1, m = !1, v = 0, _ = 0; _ < i.length; _++) {
        if (m) "'" != i.charAt(_) || r("'") ? n() : m = !1;else switch (i.charAt(_)) {
          case "d":
            f = e("d");
            break;
    ...
    formatDate: function formatDate(i, t, e) {
      if (!t) return "";
      ...
      var r = (e ? e.dayNamesShort : null) || this._defaults.dayNamesShort,
          ...
          c = "",
          u = !1;
      if (t) for (var d = 0; d < i.length; d++) {
        if (u) "'" != i.charAt(d) || n("'") ? c += i.charAt(d) : u = !1;else switch (i.charAt(d)) {
          case "d":
            c += s("d", t.getDate(), 2);
            break;
    ...
    _possibleChars: function _possibleChars(i) {
      function t(t) {
      ...
      for (var e = "", s = !1, n = 0; n < i.length; n++) {
        if (s) "'" != i.charAt(n) || t("'") ? e += i.charAt(n) : s = !1;else switch (i.charAt(n)) {
          case "d":
          case "m":
          case "y":
          case "@":
    ...
    _generateHTML: function _generateHTML(t) {
      ...
      if (p < 0 && (p += 12, f--), d) for (var g = this._daylightSavingAdjust(new Date(d.getFullYear(), d.getMonth() - r[0] * r[1] + 1, d.getDate())), g = u && g < u ? u : g; this._daylightSavingAdjust(new Date(f, p, 1)) > g;) {
        --p < 0 && (p = 11, f--);
      }
  ...
  a.widget("ui.dialog", {
    ...
    moveToTop: function moveToTop(t, e) {
      var i,
          s = this,
          n = s.options;
    ...
    _createButtons: function _createButtons(t) {
      ...
      s.uiDialog.find(".ui-dialog-buttonpane").remove(), "object" == _typeof(t) && null !== t && a.each(t, function () {
        return !(e = !0);
    ...
    _makeResizable: function _makeResizable(t) {
      function i(t) {
        return {
    ...
    _position: function _position(t) {
      var e,
          i = [],
          s = [0, 0];
      t = t ? (("string" == typeof t || "object" == _typeof(t) && "0" in t) && (1 === (i = t.split ? t.split(" ") : [t[0], t[1]]).length && (i[1] = i[0]), a.each(["left", "top"], function (t, e) {
    ...
    uuid: 0,
    maxZ: 0,
    getTitleId: function getTitleId(t) {
      var e = t.attr("id");
  ...
  c.widget("ui.slider", c.ui.mouse, {
    ...
    _setOption: function _setOption(t, e) {
      ...
      switch (c.isArray(this.options.values) && (s = this.options.values.length), c.Widget.prototype._setOption.apply(this, arguments), t) {
        ...
        case "values":
          for (this._animateOff = !0, this._refreshValue(), i = 0; i < s; i += 1) {
            this._change(null, i);
          }
  ...
  p.widget("ui.tabs", {
    ...
    _tabify: function _tabify(t) {
      ...
      for (var e, s, n, o, r, c = 0; e = this.lis[c]; c++) {
        p(e)[-1 == p.inArray(c, l.disabled) || p(e).hasClass("ui-tabs-selected") ? "removeClass" : "addClass"]("ui-state-disabled");
      }

      !1 === l.cache && this.anchors.removeData("cache.tabs"), this.lis.add(this.anchors).unbind(".tabs"), "mouseover" !== l.event && (s = function s(t, e) {
  ...
  u.each("branch form header step wrapper".split(" "), function () {
    ...
    _fastForward: function _fastForward(s, n, o) {
      var r = 0,
          a = this,
    ...
    _find: function _find(t, e, i) {
      ...
      if (null !== t && h.length) for (n = 0, o = (t = d(t)).length; n < o; n++) {
        s = null, (a = _typeof(r = t[n])) == g ? s = h.get(r) : "string" == a ? s = document.getElementById(r.replace("#", "")) : "object" == a && (r instanceof jQuery && r.length && (r = r[0]), r.nodeType && h.each(c)), s && l.push(s);
      }
      return !1 === i ? l : u(l);
    },
    _move: function _move(t, e, i, s, n) {
      var o = this,
          r = o._currentState;
      ...
      _typeof(e) == m && (n = s, s = i, i = e, e = c), !0 === i ? 0 < t ? o._fastForward(t, i, a) : n.call(o, r.stepsActivated[Math.max(0, t + (r.stepsActivated.length - 1))]) : -1 !== (t = o.stepIndex(t, e)) && (t > r.stepIndex ? o._fastForward(t, a) : a.call(o, t));
    },
    _state: function _state(t, e) {
    ...
    _transition: function _transition(t, e, i) {
      var s = this;
      ...
      var n = s.options,
          ...
          l = u.isFunction(a) ? a.call(s, o, function () {
    ...
    backward: function backward(i, t) {
      _typeof(i) == g && (t = i, i = c), t === c && (t = 1), this._currentState.isFirstStep || _typeof(t) != g || this._move(-t, !0, !1, function (t, e) {
        this._update(i, this._state(t, e));
      });
    },
    branch: function branch(t) {
      return arguments.length ? this._find(t, this.elements.branches) : this._currentState.branch;
    },
    branches: function branches(t) {
      return arguments.length ? this.branch(t).children(l.branch) : this.elements.branches;
    },
    branchesActivated: function branchesActivated() {
    ...
    forward: function forward(i, t, e) {
      _typeof(i) == g && (e = t, t = i, i = c), t === c && (t = 1), this._currentState.isLastStep || _typeof(t) != g || this._move(t, !0, e, function (t, e) {
        this._update(i, this._state(t, e));
      });
    },
    isValidStep: function isValidStep(t, e) {
      return this.isValidStepIndex(this.stepIndex(t, e));
    },
    isValidStepIndex: function isValidStepIndex(t) {
      return _typeof(t) == g && 0 <= t && t <= this._lastStepIndex;
    },
    stepCount: function stepCount() {
      return this._stepCount;
    },
    select: function select(i, t, e, s, n) {
      i instanceof u.Event || (n = s, s = e, e = t, t = i, i = c), t !== c && (u.isArray(t) ? (n = s, s = e, e = t[1], t = t[0]) : _typeof(e) == m ? (n = s, s = e, e = c) : u.isArray(e) && (n = e, e = c), this._move(t, e, s, n, function (t, e) {
        this._update(i, this._state(t, e));
      }));
    },
    ...
    step: function step(t, e) {
      return arguments.length ? (u.isArray(t) && (e = t[1], t = t[0]), _typeof(t) == g ? i = this._find(t, e !== c ? this.steps(e) : this.elements.steps) : (i = this._find(t, this.elements.steps.add(this.elements.branches))) && i.hasClass(a.branch) && (i = this._find(e || 0, this.steps(i))), i) : this._currentState.step;
      var i;
    },
    stepIndex: function stepIndex(t, e, i) {
      return arguments.length ? (u.isArray(t) ? (i = e, e = t[1], t = t[0]) : _typeof(e) == m && (i = e, e = c), (s = this.step(t, e)) ? (i ? s.siblings(l.step).andSelf() : this.elements.steps).index(s) : -1) : this._currentState.stepIndex;
      var s;
    },
    steps: function steps(t) {
      return arguments.length ? this.branch(t).children(l.step) : this.elements.steps;
    },
    stepsActivated: function stepsActivated() {
  ...
  h.extend(h.fn, {
    ...
    rules: function rules(t, e) {
      ...
      return l.required && (a = l.required, delete l.required, l = h.extend({
        required: a
      }, l)), l;
    }
  }), h.extend(h.expr[":"], {
    ...
    prototype: {
      ...
      showErrors: function showErrors(e) {
        if (e) {
          for (var t in h.extend(this.errorMap, e), this.errorList = [], e) {
            this.errorList.push({
              message: e[t],
      ...
      depend: function depend(t, e) {
        return !this.dependTypes[_typeof(t)] || this.dependTypes[_typeof(t)](t, e);
      },
      dependTypes: {
  ...
  e.prototype = {
    ...
    initEvents_: function initEvents_() {
      var t = this;
      t.events = {
    ...
    addRemove_: function addRemove_(t) {
      return t ? "add" : "remove";
    },
    build_: function build_(t) {
      var e = this,
          i = e.getLabel_(t);
    ...
    createEl_: function createEl_(t, e) {
    ...
    extend_: function extend_() {
      var t = [].slice.call(arguments),
          i = t[0],
          s = t.slice(1);
      return Object.keys(s).forEach(function (t) {
        for (var e in s[t]) {
          s[t].hasOwnProperty(e) && (i[e] = s[t][e]);
        }
      }), i;
    },
    floatLabel_: function floatLabel_(t, e) {
    ...
    getLabel_: function getLabel_(t) {
    ...
    getLabelText_: function getLabelText_(t, e) {
    ...
    resetFields_: function resetFields_() {
    ...
    resetPlaceholder_: function resetPlaceholder_(t) {
      var e = "data-placeholder",
          i = t.getAttribute(e);
      null !== i && (t.removeAttribute(e), t.setAttribute("placeholder", i));
    },
    setLabel_: function setLabel_(t, e) {
    ...
    setPlaceholder_: function setPlaceholder_(t, e) {
    ...
    setSelectPlaceholder_: function setSelectPlaceholder_(t, e) {
    ...
    wrapLabel_: function wrapLabel_(t, e) {
    ...
    return e;
  }) : "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? module.exports = e : t.FloatLabels = e;
}(window, document);